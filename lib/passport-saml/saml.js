  ...
  .then(() => {
    ...
    if (this.options.audience) {
      var audienceErr = this.checkAudienceValidityError(
                    this.options.audience, conditions.$$ && conditions.$$.AudienceRestriction);
      if(audienceErr)
        throw audienceErr;
    }
    ...
    if (attributeStatement) {
      ...
      if (attributes) {
        attributes.forEach(attribute => {
         if(!(Object.prototype.hasOwnProperty.call(attribute, '$$') && Object.prototype.hasOwnProperty.call(attribute.$$, 'AttributeValue'))) {
...
SAML.prototype.checkAudienceValidityError = function(expectedAudience, audienceRestrictions) {
  ...
  var errors = audienceRestrictions.map(function(restriction) {
    if (!restriction.$$ || !restriction.$$.Audience || !restriction.$$.Audience[0] || !restriction.$$.Audience[0]._) {
